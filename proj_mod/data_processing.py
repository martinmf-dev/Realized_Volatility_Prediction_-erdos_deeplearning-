...
def book_for_stock(str_file_path,time_id,create_para=True):
    """
    ...
    :param str_file_path: A str of the path to the file of book data of chosen stock. 
...
def trade_for_stock(str_file_path,time_id):
    """
    A function that returns a pandas dataframe containing the trade data of a stock at a chosen time_id. 
    :param str_file_path: A str of the path to the file of trade data of chosen stock. 
