...
def Default_Ext_Trans():
    ...
    if recover_time=="Y": 
        print("Recovering time id ordering, this will take a while ...\n")
        start_time = time.time()
    ...
    if create_data=="Y": 
        ...
        print("Creating RV by row_id, expected to be done in 60 seconds ...\n")
        ...
        print("Creating trade values by row id, expected to be done in 10 seconds ...\n")
        start_time = time.time()
        ...
        print("Creating trade values grouped by time id and row id separately respectively, expected to be done in 10 seconds ...")
        start_time = time.time()
        ...
        print("Creating timeseries data, expected to be done in 360 seconds ...")
        start_time = time.time()
        path_book="../raw_data/kaggle_ORVP/book_train.parquet"
